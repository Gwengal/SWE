package Übungsaufgaben.Übungsaufgabe_1;

public class FloatParser {
    public static void main(String[] args) {
        String sT1 = "-123.456f";   // erfolgreich
        String sT2 = "+123.45A3";   // erfolgreich
    ...
    private static float parseMyFloat(String sInput) throws Exception {
        ...
        // Ermittlaung der ersten Zahl aus einem String
    ...
    private static String[] getFirstNumber(String sInput) throws Exception {
        ...
        for (int i = 0; i < sInput.length(); i++) {
            ...
            if (i == 0 && !(Character.isDigit(cCur) || cCur == '+' || cCur == '-' || cCur == '.' || cCur == ',')) {
                throw new Exception(
            ...
            else if (i > 0 && !(Character.isDigit(cCur) || cCur == '.' || cCur == ',')) {
                break;
            }
